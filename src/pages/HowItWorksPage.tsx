...
const steps = [
  ...
  { icon: ShieldCheck, title: "Pay Securely", desc: "Pay through EventzHubz's secure payment system. Your money is held safely and only released to the vendor after your event is complete. Full peace of mind." },
    ...
    <main className="flex-1">
      <section className="hero-gradient text-primary-foreground py-20">
        <div className="container text-center">
          <h1 className="font-heading text-4xl md:text-5xl font-bold mb-4">How EventzHubz Works</h1>
